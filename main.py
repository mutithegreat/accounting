...
cursor.execute("create table if not exists cari_kart(id INTEGER,cari text,adres text,vergi_dairesi text,vergi_no text,telefon text,mail_adresi text,PRIMARY KEY(id AUTOINCREMENT))")
